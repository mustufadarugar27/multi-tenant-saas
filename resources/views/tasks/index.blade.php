...
{{-- Filters --}}
<form method="GET" action="{{ route('tenant.tasks.index') }}" class="mb-5">
    <div class="flex flex-wrap gap-3 items-end">
        ...
        <div>
            ...
            <select name="sort_by"
                    class="rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm
                           focus:outline-none focus:ring-2 focus:ring-indigo-500">
                @foreach (['created_at' => 'Created', 'due_date' => 'Due Date', 'priority' => 'Priority', 'status' => 'Status', 'title' => 'Title'] as $val => $label)
